...
def travelingSalesman (graph, sourceNode) :
        ...
        # Obviously, we only consider nodes that are reachable
            ...
            for neighbor in graph[currentNode] :
                if neighbor in remainingNodes :
                    ...
                    exhaustive(otherNodes, neighbor, currentPath + [neighbor], currentLength + graph[currentNode][neighbor], graph)
...
def preprocessing (mazeMap, mazeWidth, mazeHeight, playerLocation, opponentLocation, piecesOfCheese, timeAllowed) :
    ...
    (bestPath, bestLength) = travelingSalesman(metaGraph, playerLocation)
