...
def preprocessing (mazeMap, mazeWidth, mazeHeight, playerLocation, opponentLocation, piecesOfCheese, timeAllowed) :
    ...
    # We use the breadth first search algorithm from the starting location
    (routes, distances) = breadthFirstSearch(mazeMap, playerLocation)

    # Using the routes, we prepare the moves to perform
    global resultMoves
    resultMoves = pathToMoves(routesToPath(routes, piecesOfCheese[0]))
